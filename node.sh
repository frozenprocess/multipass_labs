...
K3S_TOKEN=`cat /root/node-token` K3S_URL="https://$CONTROL_IP:6443" INSTALL_K3S_EXEC="--kubelet-arg=config=/etc/kubelet.conf" INSTALL_K3S_SKIP_DOWNLOAD=true /root/k3s-install.sh
else
